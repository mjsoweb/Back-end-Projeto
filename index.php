      ...
      <section class="main_school_content">
        ...
        <div class="main_school_content_left">
          <article class="main_school_content_left_content">
            <header>
              <p>
                <span class="icon-facebook"><a href="https://www.facebook.com/?locale=pt_BR">Facebook</a>&nbsp;</span>
                <span class="icon-instagram"><a href="https://www.instagram.com/sttoremeraki?igsh=MWFnZTBma25wc2lnYw=="
    ...
    <section class="main_tutor">
      <div class="main_tutor_content">
        ...
        <section class="main_tutor_social_network">
          ...
          <article>
            <header>
              <h3><a href="https://www.instagram.com/sttoremeraki?igsh=MWFnZTBma25wc2lnYw==" target="_blank"
                  class="icon-instagram">Instagram</a></h3>
            </header>
          </article>
        </section>
        <!-- Fim redes sociais -->
